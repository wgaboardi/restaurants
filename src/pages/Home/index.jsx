...
import logo from '../../assets/rst-brasil.png';
...
const Home = () => {
  ...
  return (
    <Wrapper>
      <Container>
        <Search>
          <Logo src={logo} alt="Restaurantes do Brasil" />
          <TextField
            outlined
            label="Pesquisar"
          ...
          {restaurantSelected ? (
            <>
              ...
              {restaurantSelected?.opening_hours?.open_now ?
                <Text alerta="false">[Aberto agora.]</Text> :
                <Text alerta="true">[Fechado neste momento.]</Text>}
            </>
          ) : (
            <>
